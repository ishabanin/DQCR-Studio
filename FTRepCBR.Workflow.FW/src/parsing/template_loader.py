...
def merge_configs(
    ...
    result.workflow_template = template_config.workflow_template
    ...
    result.parameter_macro = template_config.parameter_macro
    ...
    if project_override:
        ...
        if project_override.workflow_template:
            result.workflow_template = project_override.workflow_template
        ...
        if project_override.parameter_macro:
            result.parameter_macro = project_override.parameter_macro
    ...
    if model_config.workflow_template:
        result.workflow_template = model_config.workflow_template
    ...
    if model_config.parameter_macro:
        result.parameter_macro = model_config.parameter_macro

    return result


def merge_rules(template_rules: ModelRules, model_rules: ModelRules) -> ModelRules:
